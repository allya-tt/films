...
print('Выберите один пункт из представленных ниже: \n'
      '1) по 2-м названиям фильмов вывести общий актерский состав,'
      ' список актеров, снимавшихся и в первом,'
      ' и во втором фильме и список актеров, участвующих в съемках первого,'
      ' но не участвующих в съемках второго \n'
      '2) по заданным актерам получить названия фильмов, в которых снимался хотя бы'
      ' в одном из актеров, названия фильмов'
      ' в которых снимались оба актера и названия фильмов, в которых снимался первый'
      ' актер, но не участвовал в съемках второй')
menu = int(input())
if menu == 1:
    ...
    y = defaultdict(
        list)  # получение нового словаря из старого заменой ключей значениями и наоборот,
    # ключи - актеры, значения - фильмы
